...
#[derive(Debug)]
pub struct Web3BridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl Web3BridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting Web3Bridge processing");
    
    let mut processor = Web3BridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = Web3BridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = Web3BridgeProcessor::new(false);
